...
public class Aszteroida implements Mezo, Leptetheto {
    ...
    public String toString() {
        ...
        if (mag == null) {
            ...
            sb.append("Nyersanyag: ").append(MainGUI.getKeyByValue(MainGUI.NamesMap, mag)).append(": ").append(mag.getClass().getSimpleName()).append("\n");
        }
        ...
        for (Hajo hajo : hajok) {
            lineJoiner.add(MainGUI.getKeyByValue(MainGUI.NamesMap, hajo) + ": " + hajo.getClass().getSimpleName());
        }
        sb.append(lineJoiner).append(" :hajok[0..*]").append("\n");
        lineJoiner = new StringJoiner(",");
        sb.append("Szomszedok: ");
        for (Mezo szomszed : szomszedok) {
            lineJoiner.add(MainGUI.getKeyByValue(MainGUI.NamesMap, szomszed) + ":" + szomszed.getClass().getSimpleName());
        }
